...
import {tradeDetailList,tradeDetailListExcel, getDickey, drawDetail} from '../../requests/http-req.js'
            ...
            <Spin spinning={this.state.showLoading}>
                <div style={{display: 'flex', flexDirection: 'column', marginTop: '10px', marginBottom: '20px'}}>
                    <Button style={{width: 65, marginBottom: 5, marginLeft: 5}}
                            onClick={() => this.tradeDetailListExcel()}>导出</Button>
