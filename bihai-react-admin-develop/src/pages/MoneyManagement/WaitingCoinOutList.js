...
import { getDickey, getCodeType, cashPassList} from '../../requests/http-req.js'
import ConfigNet, {
    CoinDrawStatus, StatusMap
} from '../../networking/ConfigNet'
import {
    Link
...
export default class WaitingCoinOutList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            showLoading: false,
    ...
    getData() {
        ...
        let temArr = {
            ...
            pageSize: 10,
            // coinDrawStatus: ConfigNet.WAITING_COIN_OUT,
