...
class WaitingFirstrialListSearch extends React.Component {
    state = {
        confirmDirty: false,
        autoCompleteResult: [],
                        ...
                        <FormItem style={{margin: 'auto', flex: 1, paddingRight: '15px'}} label={`币种`}>
                            {getFieldDecorator(`coinCode`, {})(
                                <Select
                                    placeholder="选择币种"
                                >
                                    <Option key={333} value={null}>全部</Option>
                                    {
...
const NewWaitingFirstrialListSearch = Form.create()(WaitingFirstrialListSearch);
export default NewWaitingFirstrialListSearch;
