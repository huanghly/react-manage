...
class LeverageTradeListSearch extends React.Component {
    state = {
        confirmDirty: false,
        autoCompleteResult: [],
                            ...
                            <FormItem style={{margin: 'auto'}} label={`状态`}>
                                {getFieldDecorator(`tradeStatus`, {})(
                                    ...
                                    >
                                        ...
                                        <Option value={'3'}>部分成交待撤</Option>
                                        {/*<Option value={'4'}>部分成交已撤</Option>*/}
                                        <Option value={'5'}>待撤</Option>
...
const NewLeverageTradeListSearch = Form.create()(LeverageTradeListSearch);
export default NewLeverageTradeListSearch;
