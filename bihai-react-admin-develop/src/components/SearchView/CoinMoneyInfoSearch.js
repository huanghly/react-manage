...
class CoinMoneyInfoSearch extends React.Component {
    state = {
        confirmDirty: false,
        autoCompleteResult: [],
...
const NewCoinMoneyInfoSearch = Form.create()(CoinMoneyInfoSearch);
export default NewCoinMoneyInfoSearch;
