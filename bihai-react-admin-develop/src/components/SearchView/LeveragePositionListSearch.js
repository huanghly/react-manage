...
class LeveragePositionListSearch extends React.Component {
    state = {
        confirmDirty: false,
        autoCompleteResult: [],
    ...
    selectRow = (e) => {
        this.setState({phone: e.mobile || null, email: e.email})
            ...
            >
                ...
                <div style={{display: 'flex', width: '100%', alignItems: 'center', flex: 1}}>
                    <Row gutter={24} style={{width: '100%'}}>
                        ...
                        <Col span={6} key={6}>
                            <FormItem style={{margin: 'auto'}} label={`类型`}>
                                {getFieldDecorator(`tradeStatus`, {})(
                                    ...
                                    >
                                        <Option value={null}>全部</Option>
                                        <Option value={'0'}>持仓中</Option>
                                        <Option value={'1'}>平仓中</Option>
                                    </Select>
                                )}
                            </FormItem>
                        </Col>
                                ...
                                {getFieldDecorator('phoneNo', {
                                    ...
                                    <div style={{
                                        ...
                                        <Button style={{marginTop: '4px', width: '100%'}}
                                                onClick={this.onFocu}>{this.state.phone && this.state.phone != null ? this.state.phone : this.state.email}</Button>
                                        {
                                            this.state.phone != '' ?
...
const NewLeveragePositionListSearch = Form.create()(LeveragePositionListSearch);
export default NewLeveragePositionListSearch;
