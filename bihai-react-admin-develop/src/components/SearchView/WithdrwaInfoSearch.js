...
class WithdrwaInfoSearch extends React.Component {
    state = {
        confirmDirty: false,
        autoCompleteResult: [],
            ...
            >
                <div style={{
                    ...
                    <div style={{width: '100%', display: 'flex', flexDirection: 'row'}}>
                        ...
                        <FormItem style={{margin: 'auto', flex: 1, paddingRight: '15px'}} label={`提现状态`}>
                            {getFieldDecorator(`coinDrawStatus`, {})(
                                <Select
                                    placeholder=""
                                    //   onChange={this.handleSelectChange}
                                >
                                    ...
                                    <Option value="10030005">待初审</Option>
                                    <Option value="10030010">待复审</Option>
                                    <Option value="10030015">待出币</Option>
                                    <Option value="10030020">出币中</Option>
                                    <Option value="10030025">出币成功</Option>
                                    <Option value="10030030">出币失败</Option>
                                    <Option value="10030035">已驳回</Option>
                                </Select>
                            )}
                        </FormItem>
...
const NewWithdrwaInfoSearch = Form.create()(WithdrwaInfoSearch);
export default NewWithdrwaInfoSearch;
