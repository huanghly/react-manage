...
class LeverMoneyInfoSearch extends React.Component {
    state = {
        confirmDirty: false,
        autoCompleteResult: [],
...
const NewLeverMoneyInfoSearch = Form.create()(LeverMoneyInfoSearch);
export default NewLeverMoneyInfoSearch;
